...
const StakingCampaignInfoByChainId: { [key: number]: StakingCampaignInfo[] } = {
  1: [
  ],
  // Kovan
  42: [
    ...
    return (
      <i-panel class="staking-rewards">
        <i-panel class="staking-layout">
          ...
          >
            <i-hstack class="content-help" visible={false} gap="0.25rem">
              <i-label caption="Need help? Please read the guide" />
              <i-label link={{ href: "https://doc.openswap.xyz/support-and-faq/staking-guide" }}>
                <i-hstack verticalAlignment="center" gap={5}>
                  <i-label caption="here" class="bold" font={{ color: Theme.colors.primary.main }}></i-label>
                  <i-icon name="external-link-alt" width="15" height="15" fill={Theme.colors.primary.main}></i-icon>
                </i-hstack>
              </i-label>
            </i-hstack>
          </i-hstack>
